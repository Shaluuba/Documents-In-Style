...
.login-bubble div + p:not(.light-blue) {
    color: grey;
}

/* General Sibling Selector */
.login-bubble div ~ p.light-blue {
...
/* Descendant Selector */
.create-bubble p:not(.light-blue) {
    margin-bottom: 5px;
}
...
/* Adjacent Sibling Selector */
.create-bubble div + p:not(.light-blue) {
    color: grey;
}
